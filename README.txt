...
From the main page, sign-up and login are available. Sign up to be able to create, edit, and delete your own posts, to post comments, and to like the posts of others.

2) Alternatively, you could download google app engine launcher to run this app on you local machine.

a) Choose "Add existing application" from the File menu in the launcher.

b) Select "Browse" to get to the folder of the program. 

c)Select an open port on your computer and hit add. 

d)Highlight the project and select "Run" and then "Browse" to see the project on localhost:(port_number).

About: 
This project is for the Intro to Backend section of Udacity's Fullstack Nanodegree. 

-The main.py file contains the python code for controlling the views and the database set-up.
...
-The templates folder holds the html files for the program. Jinja2 templating language is used to in both main.py and the templates.
